...
#####################SF
Out-File -FilePath C:\Utilities\Powershell-Scripts\SolidFire.htm
$filers="10.102.31.62","10.102.31.117","10.89.106.206","10.112.166.45","10.110.252.237"
foreach($filer in $filers)
{ 
$ControllerCredential = Get-NcCredential -controller $filer # New-Object System.Management.Automation.PsCredential($UserName,$ControllerPassword)

connect-sfcluster $filer -credential $ControllerCredential.Credential
if($filer -eq "10.102.31.62")
{
$Header1 = @"
<head>
<style>
...
<center><h1>SolidFire HC-CODPPHCISTC-PDC</h1></center><br>
<h3>Cluster capacity</h3>
"@
}
elseif($filer -eq "10.102.31.117")
{$Header1 = @"
<head>
<style>
TABLE {border-width: 1px; border-style: solid; border-color: black; border-collapse: collapse;}
...
<center><h1>SolidFire HC-CODPPHCISTC-SDC</h1></center><br>
<h3>Cluster capacity</h3>
"@
}
elseif($filer -eq "10.89.106.206")
{$Header1 = @"
<head>
<style>
TABLE {border-width: 1px; border-style: solid; border-color: black; border-collapse: collapse;}
...
<center><h1>SolidFire HC-STUPPHCISTC</h1></center><br>
<h3>Cluster capacity</h3>
"@
}
elseif($filer -eq "10.110.252.237")
{$Header1 = @"
<head>
<style>
TABLE {border-width: 1px; border-style: solid; border-color: black; border-collapse: collapse;}
...
<center><h1>SolidFire HC-ALTPPHCISTC</h1></center><br>
<h3>Cluster capacity</h3>
"@
}
else
...
"@
###############
$a= get-sfclustercapacity | select -property activeBlockSpace,provisionedSpace,UsedMetadataSpace,usedSpace,MaxUsedMetadataSpace,maxUsedSpace,maxProvisionedSpace
...
################# 
Add-Content -value "<br><h3>Cluster Threshold</h3>" -path C:\Utilities\Powershell-Scripts\SolidFire.htm
...
Add-Content -value $legend -path C:\Utilities\Powershell-Scripts\SolidFire.htm
<#
...
Add-Content -value $a -path C:\Utilities\Powershell-Scripts\SolidFire.htm
#>
Add-Content -value "<br><h3>Solidfire Drive</h3>" -path C:\Utilities\Powershell-Scripts\SolidFire.htm
...
Add-Content -value $a -path C:\Utilities\Powershell-Scripts\SolidFire.htm
Add-Content -value "<br><h3>Volume State</h3>" -path C:\Utilities\Powershell-Scripts\SolidFire.htm
...
Add-Content -value $a -path C:\Utilities\Powershell-Scripts\SolidFire.htm
Add-Content -value "<br><h3>Alerts</h3>" -path C:\Utilities\Powershell-Scripts\SolidFire.htm
